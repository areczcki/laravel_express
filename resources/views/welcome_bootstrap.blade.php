...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ asset("assets/bootstrap/vendor/bootstrap/css/bootstrap.min.css") }}" rel="stylesheet">
    

    <!-- Custom styles for this template -->
    <link href="{{ asset("assets/bootstrap/css/blog-home.css") }}" rel="stylesheet">
